...
#[test]
fn get_col_type() {
    let col_type_tests = vec![("tests/0.sor", 0, DataType::Bool),
...
#[test]
fn is_missing_idx() {
    let is_missing_tests = vec![("tests/0.sor", 0, 0, true),
...
#[ignore]
fn print_col_idx() {
    let print_col_idx_tests = vec![("tests/1.sor", 0, 3, Data::String("+1".to_string())),
